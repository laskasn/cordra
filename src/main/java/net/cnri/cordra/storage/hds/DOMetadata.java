...
public class DOMetadata {
     ...
     * Providing a null tagValue will remove any value that already exists with
     * the given tagName.
     */
     ...
     * object.
     */
    public synchronized Iterator<String> getTagNames() {
        if (fields == null)
    ...
    public String toString() {
        return "" + objectID + " dtcreated=" + dateCreated + "; dtdeleted=" + dateDeleted + "; fields:"
    ...
    public synchronized void updateModification(long timestamp) {
        ...
        if (timestamp > oldTimestamp)
            this.setTag("objmodified", String.valueOf(timestamp));
    }
}
